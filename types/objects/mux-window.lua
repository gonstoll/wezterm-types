...
---@field spawn_tab fun(self: MuxWindow, opt: { cwd?: string, args?: string, set_environment_variables?: table<string, string>, domain?: string | { Domainname: string } }): tab: MuxTabObj, pane: Pane, window: MuxWindow Spawns a program into a new tab within this window, returning the MuxTab, Pane and MuxWindow objects associated with it. When no arguments are passed, the default program is spawned. TODO
